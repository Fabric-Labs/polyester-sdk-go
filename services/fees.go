...
func NewFeeService(factory *transport.Factory, defaultSubAccountID *string) *FeeService {
	return &FeeService{transport: factory, scoped: ScopedSubAccount{DefaultSubAccountID: defaultSubAccountID}}
}
...
func (s *FeeService) GetSpotFeeRates(ctx context.Context, account AccountScope, subAccountID *string, symbolID []uint32) (models.SpotFeeRatesList, error) {
	...
	return UnaryAuth(ctx, s.transport, s.client().GetSpotFeeRates, req, decode.SpotFeeRatesListFromProto)
}
