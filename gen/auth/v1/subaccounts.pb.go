...
const file_auth_v1_subaccounts_proto_rawDesc = "" +
	...
	"\fAuth Service\x12\x18List Subaccount Activity\x1a?List audit and activity events for a sub-account, newest first.\x82\xd3\xe4\x93\x02-\x12+/v1/auth/subaccounts/{subaccount_id}/events2\xd0\x15\n" +
	...
	"\fAuth Service\x12\x17List Subaccount Invites\x1a^List incoming invitations and all invitations for sub-accounts the caller owns or administers.\x82\xd3\xe4\x93\x02\x1e\x12\x1c/v1/auth/subaccounts:invites\x12\x9c\x02\n" +
	...
	"\fAuth Service\x12\x19Respond Subaccount Invite\x1a@Accept or decline an invite as grantee, or cancel it as inviter.\x98\xb5\x18\x03\x82\xd3\xe4\x93\x025:\x01*\"0/v1/auth/subaccounts/invites/{invite_id}:respond2\xd9\x05\n" +
